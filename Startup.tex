...
\usepackage{color} % für eigene Farben (zusätzlich zu den vordefinierten)
\definecolor{darkblue}{rgb}{0,0,.5} % Definition für dunkelblau
\definecolor{darkred}{rgb}{.5,0,0} %Definition für dunkelrot
\definecolor{indigo}{RGB}{75,0,139} %Definition für dunkelrot
