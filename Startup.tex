...
As its name suggests, \apvlv allows you to read your PDF/\-DJVU/\-EPUB/\-HTML/\-TXT files in Vim-style! A focus is set on simplicity and minimalistic GUI. This way you have more space for the actual document.
...
By default, \apvlv does not support EPUB/\-DJUV/\-HTML/\-TXT format. If you want apvlv can do this, you must set that options on when execute \texttt{ccmake ..} command.
...
display a file chooser dialog to select a PDF/\-DJVU/\-EPUB/\-HTML/\-TXT file to open.

\item O

select a directory to display. After you selected the directory within the dialog, press enter and \apvlv will recursively search the path for PDFs/DJVUs/EPUB/HTML/TXTs. You will be presented with a vim-style navigation of your folders which allows you to easily access another document.
...
'map $<$C-n$>$ o'\\
in your .apvlvrc. Then, typing $<$Ctrl-n$>$ will run the 'o' command, that is, show a file chooser dialog to select a PDF/DJVU/EPUB/HTML/TXT file to open.\\
